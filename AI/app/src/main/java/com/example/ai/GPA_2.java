...
public class GPA_2 extends AppCompatActivity {
    ...
    EditText deg1, deg2, deg3, deg4, deg5, deg6, deg7, hours1, hours2, hours3, hours4, hours5, hours6, hours7;
...
//    @SuppressLint("MissingInflatedId")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.calc).setOnClickListener(view -> {
            ...
            deg7 = findViewById(R.id.gegsub7);
            if (deg7.getText().toString().isEmpty()) {
                Toast.makeText(this, "Degree 7 is Empty", Toast.LENGTH_SHORT).show();
                ok = false;
            }
            else {
                s = deg7.getText().toString();
                t = Integer.parseInt(s);
                if (t > 100 || t < 0) {
                    Toast.makeText(this, "Degree 7 contain invalid value", Toast.LENGTH_SHORT).show();
                    ok = false;
                } else
                    deg[6] = t;
            }
            ...
            hours7 = findViewById(R.id.hoursub7);
            if (hours7.getText().toString().isEmpty()) {
                ok = false;
                Toast.makeText(this, "Hour 7 is Empty", Toast.LENGTH_SHORT).show();
            }
            else {
                s = hours7.getText().toString();
                t = Integer.parseInt(s);
                if (t > 4 || t < 0) {
                    ok = false;
                    Toast.makeText(this, "Hour 7 contain invalid value", Toast.LENGTH_SHORT).show();
                } else
                    hour[6] = t;
            }
